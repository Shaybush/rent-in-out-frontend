...
const ProfileEdit = React.lazy(() => import('./views/client/profile-edit/profileEdit'));
...
const PopUpLikes = React.lazy(() => import('./views/client/postsLikes/popUpLikes/popUpLikes'));
const UserSearch = React.lazy(() => import('./views/client/userSearch/userSearch'));
...
const AppRoutes = () => {
	...
	let { search, register, showInbox, postSearch } = useSelector((state) => state.toggleSlice);
			...
			<Router>
				<Routes>
					<Route path='/' element={<Layout />}>
						...
						<Route
							path='/confirm'
							element={<ConfirmHandler action={'action'} messege={'messege'} showAction={'showAction'} />}
						/>
						{/* outLet */}
						{/* Guest Routes */}
