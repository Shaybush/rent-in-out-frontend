    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <span
                    className="w-24 h-24 rounded-full absolute -bottom-7 left-2 z-4 overflow-hidden md:-bottom-10 md:left-24 md:h-32 md:w-32">
                ...
                <span
                    className="absolute -bottom-6 left-20 z-5 text-gray-800 cursor-pointer bg-gray-300  rounded-full p-2 hover:text-gray-500 md:-bottom-9 md:left-48">
                ...
                >
                    <label className="custom-file-upload flex items-center cursor-pointer">
                        ...
                        <span className="ml-2 font-sans font-bold capitalize">
                            upload banner
                        </span>
                    </label>
                </span>
