...
// post intereface: ICardPropsModel
const Card = ({ post }) => {
	...
	return (
		<Wrapper>
			...
			>
				{/* post title */}
				<h4 className='mb-1 capitalize font-semibold text-gray-900 cursor-pointer'>{post?.title}</h4>
				...
				<div className='h-full'>
					<div className='flex items-center justify-center'>
						{/* post price */}
						<span className='text-xl md:text-2xl font-bold py-1 text-gray-900 mr-1'>{post?.price}$</span>
